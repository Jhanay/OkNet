...
public class CertificateBuilder {
    ...
    public CertificatePinner build(WeakHashMap<String, String> params) {
    ...
    public SSLSocketFactory getSocketFactory(InputStream... certificates) {
        return getSocketFactory(certificates, null, null);
    }
    ...
    public SSLSocketFactory getSocketFactory(InputStream[] certificates, InputStream bksFile, String password) {
        try {
